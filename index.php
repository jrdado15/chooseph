  ...
  if(isset($_GET['btnSubmit'])){
    ...
    if ($result) {
      if ($result->num_rows > 0) {
        ...
        echo '<script>alert("wala RECORD")</script>'; 
      }
    } else {
      echo $conn->error;
    }
  ...
  <body>
    <div class="row container-fluid">
      ...
      <div class="card" style="width: 18rem; height: 100%">
        ...
        <div class="card-body">
          <h5 class="card-title h2 mb-4">John Richard Dado</h5>
          ...
          <div id="conversations-div" class="card-body" style="max-height:20rem; overflow-y:scroll">
            <!--START Chat Person A -->
          ...
          <!--START Users Matches -->
          <div id="matches-div" class="card-body" style="display:none; max-height:20rem; overflow-y:scroll">
            <!--START Match Person A -->
            <div class="row align-items-center mb-3">
              <div class="col-4">
                <span class="img-responsive">
                  <img class="img-fluid rounded-circle z-depth-2" alt="100x100" src="https://mdbootstrap.com/img/Photos/Avatars/img%20(31).jpg" data-holder-rendered="true">
