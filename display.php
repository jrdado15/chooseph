...
if(isset($_SESSION['userid'])) {
    ...
    //get rotation number
    $idSql = "SELECT * FROM ods_users_profile WHERE email = '$email'";
    ...
    $matchSql = "SELECT * FROM ods_match_record WHERE unique_id1 = '$email' OR unique_id2 = '$email'";
    ...
    foreach ($likedUsersEmail as $likedEmail) {
        $likeSql = "SELECT * FROM ods_users_profile WHERE email = '$likedEmail'";
    ...
    $emailSql = "SELECT * FROM ods_users_profile WHERE email = '$email'";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) { 
                    ...
                    if (in_array($id, $likedUsersID)){
                        ...
                        $curr_data[] = $row;
                        $idSql2 = "SELECT * FROM ods_users_profile WHERE pub_id = '$id'";
